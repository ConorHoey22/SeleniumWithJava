...
public class ButtonIsEnabled {
	...
	public static void main(String[] args) {
		...
		//Finding the element By CSS Selector to check if the Button four IsEnabled() - This Button is disabled by Default
		System.out.println(driver.findElement(By.cssSelector("button#btn_four")).isEnabled());
		
		//Finding the element By CSS Selector to check if the Button four IsEnabled() 
		System.out.println(driver.findElement(By.cssSelector("button#btn_two")).isEnabled());
